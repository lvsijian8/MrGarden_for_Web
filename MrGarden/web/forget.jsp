...
<div id="main">
    ...
    <form class="" method="post" action="findPwd">
        ...
        <div class="row phone">
            <input type="text" id="phone" name="user_phone" placeholder="手机号"
                   onkeyup="this.value=this.value.replace(' ','')" required/>
            <img id="clear2" src="images/icon_delete.png" width="20px"/>
        </div>

        <div class="row pass">
            <input type="password" id="password1" name="user_pwd" placeholder="新密码"
                   onkeyup="this.value=this.value.replace(' ','')" required/>
        ...
        <div class="row pass">
            <input type="password" id="password2" name="password2" placeholder="重输密码"
                   onkeyup="this.value=this.value.replace(' ','')" disabled="disable" required/>
